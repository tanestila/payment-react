...
export default function RevisionCreator({ handleClose, guid }) {
  const queryClient = useQueryClient();

  const mutation = useMutation((body) => ratesAPI.addRevision(guid, body), {
    onSuccess: () => {
      queryClient.invalidateQueries("rate-revisions");
    },
  });
